...
class StableDiffusionGuidance(BaseObject):
    ...
    def compute_grad_sds(
        ...
        expanded_tensor:Float[Tensor, "B"],
    ):
        ...
        if prompt_utils.use_perp_neg:
            ...
            #hy_embeddings = torch.cat((text_embeddings, expanded_tensor), dim=1)
        ...
        **kwargs,
        ...
        if self.cfg.use_sjc:
            ...
            grad, guidance_eval_utils = self.compute_grad_sds(
                latents, t, prompt_utils, elevation, azimuth, camera_distances,expanded_tensor
            )
